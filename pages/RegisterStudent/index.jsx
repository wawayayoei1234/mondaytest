...
import Gender from '@/pages/RegisterStudent/Component/Gender/index'
import Nationality from '@/pages/RegisterStudent/Component/Nationality/index'
import Ethnicity from '@/pages/RegisterStudent/Component/Ethnicity/index'
import EducationalLevel from '@/pages/RegisterStudent/Component/Educational-level/index'
import Button from '@/pages/Register/Component/Button/index'
import icon from '@/pages/RegisterStudent/icon/graduation-cap--graduation-cap-education.svg'
        ...
        <Box sx={{ width: "100%", height: "100vh", bgcolor: "white", display: "flex", justifyContent: "center", alignItems: 'center' }}>
            <Box sx={{ display: "flex", width: '100%', px: '150px', gap: "100px", justifyContent: "center", alignItems: "center" }}>
                <Box sx={{ width: "35%", height: "80vh", borderRadius: "17px", background: "linear-gradient(to bottom, #1e6ef6, #c3ddfd)", justifyContent: "center", alignItems: "center", display: "flex", flexDirection:"column", gap:"25px" }}>
                    <Image src={icon} alt='icon' style={{ height:"100px", width:"auto" }} />
                    <Box sx={{ fontSize: "30px", color: "white", fontFamily: 'Roboto, sans-serif', fontWeight:"600" }}>Register for Student</Box>
                </Box>
